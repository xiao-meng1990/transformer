        ...
        <el-tabs type="border-card" tab-position="left">
          ...
          <el-tab-pane :label="label[1].name">
            ...
            <div v-show="firstStep" class="goods-first-step">
              ...
              <div class="m-t-10">
                <el-button @click="checkUrl" class="width100" size="small">下一步</el-button>
              </div>
              <div class="hint-info">
...
export default {
  ...
  data(){
    return {
      ...
      firstStep:false,
      form: {
        goodsUrl:"https://detail.tmall.com/item.html?id=562200283003",
        classify:"",
        goodsTitle:"",
        goodsImg:"",
        goodsDesc:"",
